...
public class SearchBusinessAdapter extends RecyclerView.Adapter<SearchBusinessAdapter.ItemViewHolder> {
  private static final String TAG = "main:SearchBusinessAdater";
  ...
  public static class ItemViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setItem(BusinessDTO busiDTO) {
      ...
      search_bSRateAvg.setText(busiDTO.getBusiness_star_avg());
